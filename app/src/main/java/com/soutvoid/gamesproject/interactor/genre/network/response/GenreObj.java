...
public class GenreObj implements Transformable<Genre> {
    ...
    public boolean equals(Object o) {
        ...
        final GenreObj other = (GenreObj) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GenreObj;
    }

    public String toString() {
        return "com.soutvoid.gamesproject.interactor.genre.network.response.GenreObj(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
}
