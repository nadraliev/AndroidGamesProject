...
public class GenreRepository {
     ...
     */
    public Observable<ArrayList<Genre>> searchGenres(String searchQuery, Fields fields, int limit, int offset, Order order) {
    ...
    /**
     * то же, что {@link #searchGenres(String, Fields, int, int, Order)}, но с фильтром
     *
     ...
     */
    public Observable<ArrayList<Genre>> getGenresById(int id, Fields fields) {
