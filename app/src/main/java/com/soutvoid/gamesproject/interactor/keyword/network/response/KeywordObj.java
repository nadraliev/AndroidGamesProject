...
public class KeywordObj implements Transformable<Keyword> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KeywordObj)) return false;
        final KeywordObj other = (KeywordObj) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof KeywordObj;
    }

    public String toString() {
        return "com.soutvoid.gamesproject.interactor.keyword.network.response.KeywordObj(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
}
