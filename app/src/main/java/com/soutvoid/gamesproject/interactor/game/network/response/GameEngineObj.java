...
public class GameEngineObj implements Transformable<GameEngine> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GameEngineObj)) return false;
        final GameEngineObj other = (GameEngineObj) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GameEngineObj;
    }

    public String toString() {
        return "com.soutvoid.gamesproject.interactor.game.network.response.GameEngineObj(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", logo=" + this.getLogo() + ", games=" + this.getGames() + ", companies=" + this.getCompanies() + ", platforms=" + this.getPlatforms() + ")";
    }
}
