...
import com.soutvoid.gamesproject.interactor.common.RealmModule;
import com.soutvoid.gamesproject.ui.common.dagger.ActivityViewModule;

import dagger.Component;

@PerScreen
@Component(dependencies = AppComponent.class, modules = {ActivityViewModule.class, RealmModule.class})
