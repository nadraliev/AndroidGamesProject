...
public class Franchise implements Serializable {
    ...
    public Franchise(Long id, String name, String slug, String url, Long createdAt, Long updatedAt, ArrayList<Long> games) {
        this.id = id;
        this.name = name;
        this.slug = slug;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        final Franchise other = (Franchise) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Franchise;
    }

    public String toString() {
        return "com.soutvoid.gamesproject.domain.franchise.Franchise(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
}
