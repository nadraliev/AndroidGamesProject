...
public class Collection implements Serializable {
    ...
    public Collection(Long id, String name, String slug, String url, Long createdAt, Long updatedAt, ArrayList<Game> games) {
        this.id = id;
        this.name = name;
        this.slug = slug;
        this.url = url;
    ...
    public String toString() {
        return "com.soutvoid.gamesproject.domain.collection.Collection(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
}
