...
public class Genre extends RealmObject implements Serializable {
    ...
    public String toString() {
        return "com.soutvoid.gamesproject.domain.genre.Genre(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
