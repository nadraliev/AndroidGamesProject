package com.soutvoid.gamesproject.domain.keyword;
...
public class Keyword implements Serializable {
    ...
    public Keyword(Long id, String name, String slug, String url, Long createdAt, Long updatedAt, ArrayList<Long> games) {
        this.id = id;
        this.name = name;
        this.slug = slug;
        this.url = url;
    ...
    public String toString() {
        return "com.soutvoid.gamesproject.domain.keyword.Keyword(id=" + this.getId() + ", name=" + this.getName() + ", slug=" + this.getSlug() + ", url=" + this.getUrl() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ", games=" + this.getGames() + ")";
    }
}
